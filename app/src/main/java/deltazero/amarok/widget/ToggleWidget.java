...
public class ToggleWidget extends AppWidgetProvider {
  ...
  /**
   * Initialize widget state observer. Should be invoked in {@link
   * deltazero.amarok.AmarokApplication#onCreate()}, after {@link Hider#state} is initialized.
   *
  ...
  private static void updateAllWidgets(Context context) {
    ...
    int[] appWidgetIds =
        appWidgetManager.getAppWidgetIds(new ComponentName(context, ToggleWidget.class));
