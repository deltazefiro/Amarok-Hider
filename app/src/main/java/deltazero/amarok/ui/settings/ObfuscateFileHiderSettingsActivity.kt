...
class ObfuscateFileHiderSettingsActivity : AmarokActivity() {
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent { AmarokTheme { ObfuscateSettingsScreen(onBack = { finish() }) } }
  }
}
...
private fun ObfuscateSettingsScreen(onBack: () -> Unit) {
  ...
  var obfuscateTextEnhanced by remember {
    mutableStateOf(PrefMgr.getEnableObfuscateTextFileEnhanced())
  }
