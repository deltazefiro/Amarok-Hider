...
public class AppInfoUtil {
  ...
  private boolean isRootApp(ApplicationInfo appInfo) {
    boolean isXposedModule =
        appInfo.metaData != null && appInfo.metaData.containsKey("xposedmodule");
