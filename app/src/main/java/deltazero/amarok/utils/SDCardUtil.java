...
public class SDCardUtil {
   ...
   * @see <a
   *     href="https://stackoverflow.com/questions/11281010/how-can-i-get-the-external-sd-card-path-for-android-4-0/27197248#27197248">...</a>
   */
  public static List<String> getSdCardPaths(
      Context context, boolean includePrimaryExternalStorage) {
      ...
      if (!storageVolumes.isEmpty()) {
        ...
        for (StorageVolume storageVolume : storageVolumes) {
          ...
          if (storageVolume
                  ...
                  .equals(primaryVolume.getMediaStoreVolumeName())
    ...
    if (externalCacheDirs.length == 0) return null;
    ...
    if (externalCacheDirs[0] != null
        && (includePrimaryExternalStorage || externalCacheDirs.length == 1))
