...
public class EasterEggUtil {
  ...
  public static Party rainParty =
      new PartyFactory(new Emitter(5, TimeUnit.SECONDS).perSecond(100))
          .angle(Angle.BOTTOM)
          .spread(Spread.ROUND)
  ...
  public static Party explodeParty =
      new PartyFactory(new Emitter(100L, TimeUnit.MILLISECONDS).max(100))
          .spread(360)
          .shapes(Arrays.asList(Shape.Square.INSTANCE, Shape.Circle.INSTANCE))
          .colors(Arrays.asList(0xfce18a, 0xff726d, 0xf4306d, 0xb48def))
