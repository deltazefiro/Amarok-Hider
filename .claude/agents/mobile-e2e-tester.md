...
- Only access code for navigation shortcuts, onboarding flows, or element IDs, NEVER for root cause analysis.
...
1. **Create backlog file**: Create `./tmp/e2e_test_backlog.md`.
